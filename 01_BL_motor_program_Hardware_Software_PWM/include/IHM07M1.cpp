...
static const int F_PWM = 2000; //95kHz
static const int F_PWM_Software = 2000; // 2kHz

static const int MOD_F = 500000;
static const int MOD_F_Software = 20000;
...
void IHM07M1::begin()
{
    ...
    gpioSetPWMrange(IN3, MOD_F_Software);
    gpioSetPWMfrequency(IN3, F_PWM_Software);
...
void IHM07M1::outputSoftwarePWM(int IN_No, double voltage)
{
    ...
    int MOD_F_value = static_cast<int>(MOD_F_Software * voltage_Inv/supply_voltage);
