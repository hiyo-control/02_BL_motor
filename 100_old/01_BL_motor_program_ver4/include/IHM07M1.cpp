...
void IHM07M1::outputUVWVoltage(vector<double> V_uvw)
{
    cout << "U phase = " << V_uvw[0] << endl;
    cout << "V phase = " << V_uvw[1] << endl;
    cout << "W phase = " << V_uvw[2] << endl;
